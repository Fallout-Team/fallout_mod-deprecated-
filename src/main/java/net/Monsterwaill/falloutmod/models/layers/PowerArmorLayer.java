package net.Monsterwaill.falloutmod.models.layers;
...
@OnlyIn(Dist.CLIENT)
public class PowerArmorLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    private static final ResourceLocation WINGS_LOCATION = new ResourceLocation("textures/entity/elytra.png");
    private final PowerArmorModel<T> powerArmorModel;

    public PowerArmorLayer(RenderLayerParent<T, M> p_174493_, EntityModelSet p_174494_) {
        super(p_174493_);
        this.powerArmorModel = new PowerArmorModel<>(p_174494_.bakeLayer(PowerArmorModel.LAYER_LOCATION));
    }
    ...
    public void render(PoseStack p_116951_, MultiBufferSource p_116952_, int p_116953_, T p_116954_, float p_116955_, float p_116956_, float p_116957_, float p_116958_, float p_116959_, float p_116960_) {
        ...
        if (shouldRender(itemstack, p_116954_)) {
            ...
            this.getParentModel().copyPropertiesTo(this.powerArmorModel);
            this.powerArmorModel.setupAnim(p_116954_, p_116955_, p_116956_, p_116958_, p_116959_, p_116960_);
            ...
            this.powerArmorModel.renderToBuffer(p_116951_, vertexconsumer, p_116953_, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
            p_116951_.popPose();
        }
    }
